...
fetch('/fetchNames').then(res => res.json()).then(info => {
    const playerNames = info.data.reduce((arr, element) => {
        return [...arr, element.first_name + " " + element.last_name];
    }, []);
    //document.getElementById('container').innerText = JSON.stringify(playerNames);
    console.log(playerNames);
    autocomplete(document.getElementById("Input"), playerNames);
